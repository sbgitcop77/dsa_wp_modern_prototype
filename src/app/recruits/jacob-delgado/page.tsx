...
export const metadata: Metadata = {
  title: "Jacob Delgado — Class of 2025 | Recruits",
  description:
    "Jacob Delgado — Catcher/3B, Class of 2025. 80 mph throw velo, 88 mph exit velo. Training at The Diamond Sports Academy in Odenton, MD.",
};

const STATS = [
  { label: "Exit Velo", value: "88 mph" },
  { label: "Throw Velo", value: "80 mph" },
  { label: "Pitch Velo", value: "74 mph" },
  { label: "60-Yard Dash", value: "7.12 sec" },
  { label: "Vertical Jump", value: "26 in" },
  { label: "Broad Jump", value: "98 in" },
];

export default function JacobDelgadoPage() {
  return (
    <>
      {/* Hero */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-10 items-end">
            <div className="lg:col-span-2 pb-12">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-white mb-3">Jacob Delgado</h1>
              <p className="text-white/70 text-xl mb-6">Catcher / Third Base &nbsp;·&nbsp; Bats R / Throws R</p>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-[#6c757d] leading-relaxed text-lg">
                Jacob is a defensive-minded catcher with a strong arm, quick transfer, and outstanding blocking ability. His offensive approach shows he drives the ball gap-to-gap with a consistent on-plane path.
              </p>
            ...
            <div>
              <div className="bg-[#F7F7F7] border border-gray-200 rounded-xl p-6 sticky top-24">
                ...
                <p className="text-[#6c757d] text-sm leading-relaxed mb-5">
                  For recruiting inquiries about Jacob Delgado, please contact The Diamond Sports Academy directly.
                </p>
