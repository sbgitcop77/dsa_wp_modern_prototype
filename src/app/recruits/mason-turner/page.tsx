...
export const metadata: Metadata = {
  title: "Mason Turner — Class of 2026 | Recruits",
  description:
    "Mason Turner — RHP/3B, Class of 2026. 84 mph pitch velo, 92 mph exit velo. Training at The Diamond Sports Academy in Odenton, MD.",
};

const STATS = [
  { label: "Exit Velo", value: "92 mph" },
  { label: "Throw Velo", value: "86 mph" },
  { label: "Pitch Velo", value: "84 mph" },
  { label: "60-Yard Dash", value: "6.83 sec" },
  { label: "Vertical Jump", value: "29 in" },
  { label: "Broad Jump", value: "106 in" },
];

export default function MasonTurnerPage() {
  return (
    <>
      {/* Hero */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-10 items-end">
            <div className="lg:col-span-2 pb-12">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-white mb-3">Mason Turner</h1>
              <p className="text-white/70 text-xl mb-6">Pitcher (RHP) / Third Base &nbsp;·&nbsp; Bats R / Throws R</p>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-[#6c757d] leading-relaxed text-lg">
                Mason is a dynamic two-way athlete with advanced athleticism and next-level explosiveness. Training has focused on bat speed, footwork, and throwing velocity through individualized sessions and tech-based development. Coaches note his leadership qualities, attention to detail, and learning capability — projecting him as a strong collegiate prospect.
              </p>
            ...
            <div>
              <div className="bg-[#F7F7F7] border border-gray-200 rounded-xl p-6 sticky top-24">
                ...
                <p className="text-[#6c757d] text-sm leading-relaxed mb-5">
                  For recruiting inquiries about Mason Turner, please contact The Diamond Sports Academy directly.
                </p>
